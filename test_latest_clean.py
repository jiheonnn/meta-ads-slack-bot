...
# 테스트 환경 변수
SLACK_WEBHOOK_URL = "https://hooks.slack.com/services/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"
META_ACCESS_TOKEN = "EAAKUZAdQJpPgBPIgmlSwOP35imYOYzJGY9PVBAowJZA55r5MWSvpaHmQxwJNYboVJ3f00VBlZAlVO3JhhLQ8AXkgoTt9S6MVZCPXHa9mzaXF9G8dnbmJSl7sQzb97gmiDZA8LsZBuQYnH1WDd64Qwvclm5zcZAelHLZCiuNtAWI7URjpC07p9l7oLCMs1ZB8GKr8QdZCYDY7y9h7EZBMUFq0tsZA"
...
def main():
    ...
    try:
        ...
        print(f"✅ 계정 데이터: {'수신' if account_perf else '없음'}")
        
        ads = manager.get_ad_performance()
        print(f"✅ 소재: {len(ads)}개")
        
        weekly_comp = manager.get_weekly_comparison()
        print(f"✅ 주간 비교: {'있음' if weekly_comp else '없음'}")
